...
class CourseAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Basic information', {
            'fields': ('department', 'name','course_level','course_circle','start_date','end_date','director','enrollment_length','coursetype','TotalStudent','AheadTime', 'description','open_enrollments')
        }),
        #('Class detail', {
